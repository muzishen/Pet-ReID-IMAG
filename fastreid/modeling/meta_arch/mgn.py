...
class MGN(nn.Module):
    ...
    def losses(self,
        ...
        if 'CircleLoss' in loss_names:
            ...
            loss_dict['loss_circleb1'] = pairwise_circleloss(
                b1_pool_feat,
                gt_labels,
            ...
            loss_dict['loss_circleb2'] = pairwise_circleloss(
                b2_pool_feat,
                gt_labels,
                circle_kwargs.get('margin'),
                circle_kwargs.get('gamma')
            ...
            loss_dict['loss_circleb3'] = pairwise_circleloss(
                b3_pool_feat,
                gt_labels,
                circle_kwargs.get('margin'),
                circle_kwargs.get('gamma')
            ...
            loss_dict['loss_circleb22'] = pairwise_circleloss(
                b22_pool_feat,
                gt_labels,
                circle_kwargs.get('margin'),
                circle_kwargs.get('gamma')
            ...
            loss_dict['loss_circleb33'] = pairwise_circleloss(
                b33_pool_feat,
                gt_labels,
                circle_kwargs.get('margin'),
                circle_kwargs.get('gamma')
